...
ANNOTspeechh <- speechdf %>%
  mutate(annoTXT = map(Transcript, ~ udpipe_annotate(model, .x) %>% as_tibble %>%   
                         mutate(annotTXT = paste(token, "/", xpos, collapse = " ", sep = ""))))
...
saveRDS(ANNOTspeech, "Private/articles-analysis1.csv")
...
massNN <- c("admiration/NNM", "advice/NNM", "air/NNM", "anger/NNM", "anticipation/NNM",
  ...
  "weather/NNM", "wheat/NNM", "wisdom/NNM", "work/NNM", "food/NNM", "ham/NNM", "beef/NNM", "lettuce/NNM", "tv/NNM")
